...
let UsuariosService = class UsuariosService {
    ...
    async create(createUsuarioDto) {
        const { clave, fecha_registro } = createUsuarioDto, datos = __rest(createUsuarioDto, ["clave", "fecha_registro"]);
        var salto = bcrypt.genSaltSync(10);
        var hash = bcrypt.hashSync(clave, salto);
        const datosUsuario = Object.assign(Object.assign({}, datos), { clave: hash, fecha_registro: new Date().toJSON().slice(0, 10) });
