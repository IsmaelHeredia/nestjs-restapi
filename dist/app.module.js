...
const tiposusuarios_module_1 = require("./modules/tiposusuarios/tiposusuarios.module");
...
const acceso_module_1 = require("./modules/acceso/acceso.module");
const jwt_strategy_1 = require("./modules/acceso/jwt.strategy");
let AppModule = class AppModule {
};
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forRoot('mongodb://127.0.0.1:27017/sistemaNestJS'),
            usuarios_module_1.UsuariosModule,
            tiposusuarios_module_1.TiposUsuarioModule,
